...
O comércio eletrônico tem tres tipos de usuários. O tipo administrador representa o gestor do site, o tipo Visitante representa o usuário não cadastrado que deseja visitar o site e o tipo Cliente representa um usuário já cadastrado. 
...
| F14 | Revisar dados cadastrais	| Os clientes podem alterar seus dados cadastrais permitindo assim que façam, por exemplo, alteração do endereço de entrega
