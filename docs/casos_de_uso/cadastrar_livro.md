...
| 01/04/2024 | **1.01** | Correção do dicionário de dados  | Cortez |
| 09/04/2024 | **1.02** | Remoção de atributos 'Nº de páginas' e 'edição' e de seus respectivos fluxos | Cortez
...
|3. O admin insere os dados do livro a ser cadastrado (Capa, Título, Autor, Descrição, Gênero, Data de Publicação, ISBN, Editora e Idioma) | --- |
...
### 7. Diagrama de classe de domínio
